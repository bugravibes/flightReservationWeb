...
<div class="reservation-list">
    ...
    <% } %>
        ...
        <label>
            <input class="paymentType" type="radio" name="flightType" value="Credit Card"> Credit Card
            <input class="paymentType" type="radio" name="flightType" value="Cash" checked> Cash
        </label>
    </div>
    <div class="payment">
        <button type="button" onclick="processPayment()" >Payment</button>
    </div>
<%updatePayment.updatePaymentStatus(PNR); %>>
    <script>
